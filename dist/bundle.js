...
eval("function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Box = function Box() {\n  var _this = this;\n\n  _classCallCheck(this, Box);\n\n  this.styleBox = function () {\n    var style = _this.box.style;\n    style.width = \"100px\";\n    style.height = \"100px\";\n    style.position = \"absolute\";\n    style.top = \"\".concat(_this.pos, \"px\");\n    style.backgroundColor = \"blue\";\n  };\n\n  this.moveBox = function () {\n    var box = _this.box;\n    var offset = 10;\n    var windowSize = window.innerHeight - box.offsetWidth;\n    var maxDistToTravel = windowSize - windowSize % offset;\n    var end = maxDistToTravel;\n    setInterval(function () {\n      if (_this.pos === end) {\n        offset *= -1; // reverses current direction\n\n        end = Math.abs(maxDistToTravel - end);\n      }\n\n      _this.pos += offset;\n      box.style.top = _this.pos + \"px\";\n      box.style.left = _this.pos + \"px\";\n    }, 1000);\n  };\n\n  this.box = document.createElement(\"div\");\n  document.body.appendChild(this.box);\n  this.pos = 50;\n  this.styleBox();\n  this.moveBox();\n};\n\nvar box = new Box();\n\n//# sourceURL=webpack:///./src/index.js?");
